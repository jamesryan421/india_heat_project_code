...
get_split_pipeline <- function(){
  pipeline_estimation <- list(
    ...
    #tar_target(master_wage_early_coefs,
    #           do.call(cbind, wage_early_coefs)),
    #tar_target(master_wage_pc_early_coefs,
    ...
    # tar_target(master_wage_early_pc_controls,
    #            do.call(cbind, wage_early_pc_coefs)[1:9,]),
    # tar_target(master_wage_early_fes,
    #            do.call(cbind, wage_early_coefs)[10:dim(master_wage_early_coefs)[1],]),
    # tar_target(master_wage_early_pc_fes,
    #            do.call(cbind, wage_early_pc_coefs)[10:dim(master_wage_early_pc_coefs)[1],]),
